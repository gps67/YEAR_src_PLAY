...
struct EXPR;
#ifndef YYBISON
#warning yacc_name_tab_hh SOON to lex
#include "../obj/gen_e1_yacc.tab.hh"
#warning yacc_name_tab_hh IN 
#endif
/*
...
"" return TOKEN(LEX_EOLN);
"" return TOKEN(LEX_IDENTIFIER);
"" return TOKEN(LEX_WS);
"" return TOKEN(LEX_DOUBLE);
"" return TOKEN(LEX_INTEGER);
