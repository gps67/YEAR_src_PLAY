...
#line 1 "gen_e1_yacc.y" /* yacc.c:337  */
...
#include "gen_e1_yacc.tab.hh" // bison lists PUNCT_PLUS as int"
 ...
 const char * str_of_token( int tok ) {
  switch( tok ) {
   ...
   case LEX_EOLN:	 return "";
   case LEX_IDENTIFIER:	 return "";
   case LEX_WS:	 return "";
   default:
...
#ifndef YY_YY_GEN_E1_YACC_TAB_HH_INCLUDED
# define YY_YY_GEN_E1_YACC_TAB_HH_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
# define YYTOKENTYPE
  enum yytokentype
  {
    PUNCT_EQUAL_EQUAL = 258,
    PUNCT_NOT_EQUAL = 259,
    PUNCT_LT_EQUAL = 260,
    PUNCT_GT_EQUAL = 261,
    PUNCT_LT_LT = 262,
    PUNCT_GT_GT = 263,
    PUNCT_LT_LT_EQUAL = 264,
    PUNCT_GT_GT_EQUAL = 265,
    PUNCT_PLUS_PLUS = 266,
    PUNCT_LT = 267,
    PUNCT_GT = 268,
    PUNCT_EQUAL = 269,
...
#endif /* !YY_YY_GEN_E1_YACC_TAB_HH_INCLUDED  */
...
{
  "$end", "error", "$undefined", "PUNCT_EQUAL_EQUAL", "PUNCT_NOT_EQUAL",
  "PUNCT_LT_EQUAL", "PUNCT_GT_EQUAL", "PUNCT_LT_LT", "PUNCT_GT_GT",
  "PUNCT_LT_LT_EQUAL", "PUNCT_GT_GT_EQUAL", "PUNCT_PLUS_PLUS", "PUNCT_LT",
  "PUNCT_GT", "PUNCT_EQUAL", "PUNCT_L_PAR", "PUNCT_PAR_R", "PUNCT_L_CURLY",
  "PUNCT_CURLY_R", "PUNCT_DOT", "PUNCT_PLUS", "PUNCT_MINUS", "PUNCT_STAR",
  "PUNCT_SLASH", "PUNCT_CIRC", "PUNCT_AMP", "PUNCT_PERCENT", "PUNCT_PIPE",
  "PUNCT_TILDE", "RW_if", "LEX_EOLN", "LEX_IDENTIFIER", "LEX_WS",
  "PUNCT_CARET", "$accept", "expr_ident", "BOP", "expr", "lines", "line",
  "top", YY_NULLPTR
};
#endif
...
{
     -25,    12,     2,    12,    12,   -25,    12,   -24,   -16,   -25,
     -25,     3,    39,   -24,    25,   -25,    12,   -25,    12,   -25,
     -25,   -25,   -25,   -25,    12,    12,   -25,   -25,    39,    39,
      39,    39
};
...
{
      18,    21,     0,     0,     0,     4,     0,    16,     0,    19,
       1,     0,    15,     2,     0,     3,     0,     5,     0,     6,
       9,     7,     8,    20,     0,     0,    17,    13,    10,    11,
      12,    14
};
...
{
      11,    12,    10,    14,    16,    17,    18,    19,    15,    20,
      21,    22,    13,    28,    23,    29,     0,    24,     0,    26,
       0,    30,    31,    16,    17,    18,    19,     3,    20,    21,
      22,     0,     0,     4,     0,     0,    24,     0,     0,     0,
       0,     0,     0,     5,     6,    16,    17,    18,    19,     0,
      20,    21,    22,     0,     0,     0,     0,    27,    24,    16,
...
{
       3,     4,     0,     6,    20,    21,    22,    23,    32,    25,
      26,    27,     6,    16,    30,    18,    -1,    33,    -1,    16,
      -1,    24,    25,    20,    21,    22,    23,    15,    25,    26,
      27,    -1,    -1,    21,    -1,    -1,    33,    -1,    -1,    -1,
      -1,    -1,    -1,    31,    32,    20,    21,    22,    23,    -1,
      25,    26,    27,    -1,    -1,    -1,    -1,    32,    33,    20,
...
{
       0,    38,    40,    15,    21,    31,    32,    35,    37,    39,
       0,    37,    37,    35,    37,    32,    20,    21,    22,    23,
      25,    26,    27,    30,    33,    36,    16,    32,    37,    37,
      37,    37
};
