...
#ifndef YYBISON
#warning yacc_name_tab_hh SOON into .y 
#include "../obj/gen_e1_yacc.y"
#warning yacc_name_tab_hh defined 
#else
#pragma message("yacc_name_tab_hh NOT INCLUDED")
#endif
          #include "str1.h"
  #if 0
          struct YYSTYPE;
 ...
 const char * str_of_token( int tok ) {
  switch( tok ) {
   ...
   case LEX_WS:	 return "";
   case LEX_DOUBLE:	 return "";
   case LEX_INTEGER:	 return "";
   default:
