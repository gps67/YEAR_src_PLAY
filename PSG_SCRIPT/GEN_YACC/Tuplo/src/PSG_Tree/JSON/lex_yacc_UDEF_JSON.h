#ifndef lex_yacc_UDEF_JSON_H
#define lex_yacc_UDEF_JSON_H
...
class lex_yacc_UDEF_JSON : public lex_yacc_UDEF { public:
...
// 	virtual bool add_yacc_for_C_EXPR();
 	virtual bool add_lex_for_JSON();
 	virtual bool add_yacc_for_JSON();
