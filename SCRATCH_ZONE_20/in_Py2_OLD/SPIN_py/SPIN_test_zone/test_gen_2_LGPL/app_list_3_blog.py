...
accts_gtk.desc_text = """
	...
	It produces a nifty companies house report in PDF.
"""
...
lib_base.desc_text = """
	...
	event-driven file-descriptors, unix-time, etc
"""

lib_base2 = libs_apps_lib_item( "lib_base2" )
lib_base2.lang = "C++"
lib_base2.desc_line = "extended library of specific features: js gtk pdf"
lib_base2.desc_text = """
	Things like PDF, X11, Gtk, JavaScript. If your app needs
