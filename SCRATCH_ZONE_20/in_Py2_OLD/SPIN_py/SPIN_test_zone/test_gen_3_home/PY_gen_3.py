...
el_TITLE.add_text( "Information Cascade Ltd" )
...
if 1:
	...
	TD.add_elem( "BR" )
	A=TD.add_elem( "A" )
	# A.add_attr( "href", "LGPL/index1.html" )
	A.add_attr( "href", "http://www.information-cascade.co.uk/LGPL/index1.html" )
	IMG=A.add_elem( "IMG" )
...
#	IMG.add_attr( "alt", "You know you dont want to" );
	IMG.add_attr( "alt", "postcode search" );
...
if 1:
	...
	# TD.add_elem( "BR" )
	A=TD.add_elem( "A" )
	A.add_attr( "href", "http://freecode.com" )
#	A.add_attr( "href", "http://freshmeat.net" )
	IMG=A.add_elem( "IMG" )
#	IMG.add_attr( "src", "http://images.freshmeat.net/img/logo.gif" )
#	IMG.add_attr( "src", "http://a.fsdn.com/fm//images/fm_logo.png?1290590607" )
	IMG.add_attr( "src", "http://a.fsdn.com/fm/images/fm_logo.png?1319893233")

#	IMG.add_attr( "src", "fm_logo_white_150_normal.png" )
	IMG.add_attr( "border", "0" )
	...
	H2=TD.add_elem( "H2" )
	# H2.add_elem( "BR" )
	H2.add_text( "FREECODE.com" )
	H2.add_elem( "BR" )
	H2.add_text( "was Freshmeat" )
	H2.add_elem( "BR" )
...
if 1:
	...
	TD.add_text( "0118 975 6229" )
	TD.add_elem( "BR" )
	TD.add_text( "lists @ Information-Cascade . co.uk " )
	TD.add_elem( "BR" )
	TD.add_text( "COMP: 2549782 . VAT: 744 8831 03 " )

# ROW private link for Carment 
if 0:
	TR=T1.add_elem( "TR" )
	TD=TR.add_elem( "TD" )
	TD.add_attr( "colspan", "2" )
	...
	A=TD.add_elem( "A" )
	A.add_attr( "href", "carmen.txt" )
	A.add_text( "http://www.gps.talktalk.net/carmen.txt" )
