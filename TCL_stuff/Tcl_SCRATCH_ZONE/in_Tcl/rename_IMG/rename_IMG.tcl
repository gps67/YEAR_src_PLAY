...
set ZONE_NAME ACOUSTIC_COUCH
set ZONE_NAME BH6_XMAS
set ZONE_NAME Ella_eve
set ZONE_NAME PIER
set ZONE_NAME BH6_walk
set ZONE_NAME RSAC
set ZONE_NAME BH6_pages
set ZONE_NAME BH6_Sherboune
set ZONE_NAME BH6_Yeovil_Hip_Recovery
set ZONE_NAME COUCH
set ZONE_NAME Ella_One_CAM_2
set ZONE_NAME BH6_a
set ZONE_NAME Ella_One_CAM_1
...
#      1234567890123.mp3
	...
	foreach f $L1 {
	  ...
	  foreach {YEAR MM DD hh mm ss NNNN ASTR ext} { 1999 12 31 23 59 00 1000 "" JPG } {}
	 ...
	 # delete after debug
	  ...
	  if [regexp $re_SAM_1000 $f all NNNN ASTR ext] {
	   puts "MATCH"
	  }
	 # delete after debug
	 ...
	 #	macro_know_date_came_from_filename ;# DONE in LOOP init
	  ...
	  } elseif [regexp $re_SAM_1000 $f all NNNN ASTR ext] {
		macro_know_date_from_stat_file $f1
		macro_calc_name_one
		macro_offer_rename
		continue
