...
gtk_text_top_app::~gtk_text_top_app()
{
	e_print("~gtk_text_top_app();\n");
	// e_print_set( NULL );
}

// void gtk_text_top_app::file_save( str2 * _filename, bool compressed )
// {
//	filename = _filename;
//	compress = compressed;
//
...
bool gtk_text_top_app::file_open( str2 * first_file )
{
...
w_menu_bar * gtk_text_top_app::xx_make_menu_bar()
{
...
: TOPAPP_Task_Window_Major( holder, "GTK_TEXT", 450, 450, first_file, false )
{                                  
//	compress = TRUE;
