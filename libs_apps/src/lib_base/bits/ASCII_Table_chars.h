/*
 ENTIRE FILE COMMENTED OUT OK

	rework PUNCT_LESSTHAN_LESSTHAN "<<" ASCII_LESSTHAN

	#IFDEF import_tables_dialect_names

	# define SPACE ASCII_SPACE
...
Text::Unidecode (3pm) - - plain ASCII transliterations of Unicode text
...
https://www.prepressure.com/fonts/basics/character-names
	...
	lists lots of chars separately
	many < 7E many > A0
	name maybe a bit off
	does show that HTML names != ASCII names
	(maybe move to HTML or own names ?)
		Q2 == "
		Q1 == '
		QB -- `
		Q_PAIR_Typeset_... (not Apostrophe)
...
# man ascii Glyphs - only summarised here [a-z][A-Z][0-9][{} ...
man ascii
