...
//! See tv_panel.h - volume slider fixup thing
...
class line_factor_slider : public w_scale_fix
{
 ...
 public:
	...
	*/
	line_factor_slider( tv_panel * _panel )
...
/*!
	tv_panel calls set_factor( fade_factor * channel_factor )
*/
