...
/*
	move these demo values to cfg_demo_1_defaults.h
*/
...
*/
struct kf_cfg_demo_1 : public kf_cfg_demo_0
{ 
...
//o	bool save_file_() {return ((kf_cfg_demo_0*)this)->save_file( (STR0)file_name ); }
	...
	kf_cfg_demo_1(); // INTENSIVE - CTORS all vars
	~kf_cfg_demo_1(); // 
	...
	static const char * get_filename_default_hardcoded(); // cfg_demo_1.kf
